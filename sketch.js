...
left_wall = Bodies.rectangle(800,620,5,300,ground_option)
World.add(world,left_wall)
fill("yellow")

right_wall = Bodies.rectangle(1200,620,5,300,ground_option)
...
function draw() {
  ...
  rect(left_wall.position.x,left_wall.position.y,5,300)

  rect(right_wall.position.x,left_wall.position.y,5,300)
